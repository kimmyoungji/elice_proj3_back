...
| 김명지 | 백엔드 | 로컬 & 구글로그인 구현 / users_MVP API 작성 / image_MVP API작성 / RDS생성및 연결 / S3생성및 연결 / HTTPS 구현 / VM에 배포 |
| 장재웅 | 백엔드 | record_MVP API 작성 |
| 최유림 | 백엔드 | OPEN AI API 연동 / 식품데이터API 연동 / cumulative_record_MVP API 작성 / food_info_MVP API 작성 |
